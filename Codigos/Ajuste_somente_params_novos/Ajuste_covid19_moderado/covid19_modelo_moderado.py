...
def carrega_dados():
    data_nk = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\NK_moderado.csv', sep = ',')
    ...
    data_igm = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\IgM_moderado.csv', sep = ',')
    data_igg = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\IgG_moderado (1).csv', sep = ',')
    ...
    data_tcd4 = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\TCD4_moderado (1).csv', sep = ',')
    data_tcd8 = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\TCD8_moderado.csv', sep = ',')
    data_cellB = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\Bcell_moderado.csv', sep = ',')
...
params_ajs = ['pi_v', 'beta_ap', 'cap1', 'cap2', 'beta_apm', 'beta_th', 'delta_th', 'beta_tk', 'beta_pl',
              'beta_ps', 'delta_ps', 'delta_pl', 'pi_ps', 'pi_pl', 'delta_am', 'gama_c', 'V0', 'Ap0', 'B0', 'Nmax']
...
params_ajs = ['pi_v', 'beta_ap', 'cap1', 'cap2', 'beta_apm', 'beta_th', 'pi_th', 'delta_th',
              ...
              'pi_pl', 'gama_c', 'qn', 'dn', 'gamma_iNK', 'pi_cNK', 'V0', 'Ap0', 'B0', 'NK0', 'Nmax']

params_ajs = ['pi_v', 'kv1', 'kv2', 'kv3', 'beta_ap', 'gamma_apm','beta_th','delta_th','beta_tk','delta_tk','beta_ps','delta_ps','beta_pl',
    'pi_ps','pi_pl','delta_am','delta_ag','pi_capm','pi_ci','pi_ctke','gama_c','qn','dn','gamma_iNK','V0','NK0']

params_ajs = ['pi_v', 'kv1', 'kv2', 'beta_ap', 'gamma_apm', 'beta_th', 'pi_th', 'delta_th', 'alpha_tk', 'beta_tk', 'pi_tk', 
              'delta_tk', 'alpha_b', 'pi_b1', 'pi_b2','beta_ps', 'beta_pl', 'beta_bm', 'pi_ps', 'pi_pl', 'delta_am', 'gama_c', 'qn', 
