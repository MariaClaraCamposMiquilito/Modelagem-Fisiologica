...
#params_otimos[0] =  0.5  # pi_v
##params_otimos[2] = 0.1 # beta_ap
#params_otimos[3] = 0.5 # cap1
#params_otimos[4] = 1e7   # cap2
#params_otimos[5] = 0.9   # beta_apm
#params_otimos[6] = 0.5  # beta_th
#params_otimos[7] = 0.0005 # delta_th
#params_otimos[8] = 0.01  # beta_tk
#params_otimos[] =       # pi_ps
#params_otimos[9] = 0.01  # gamma_c
#params_otimos[11] = 0.6  # pi_cNK
#params_otimos[12] = 1e6  # Ap0
#params_otimos[13] = 6e5  # TkN0
#params_otimos[14] = 1e4  # B0
...
t = np.linspace(0, 70, 3500)

sol = solve_ivp(modelo, [0, 70], y0, args=(p,), method='Radau', t_eval=t)
...
## Citocinas
ax[0, 1].plot(sol.t, np.log10(sol.y[14] + 1), color='blue')
...
ax[1, 3].grid()
ax[1, 3].plot(sol.t, np.log10(sol.y[8] + sol.y[11]  + 1), color = 'green')
