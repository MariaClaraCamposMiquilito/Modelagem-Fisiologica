...
def carrega_dados():
    data_nk = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\NK_severo.csv', sep = ',')
    ...
    data_igm = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\IgM_severo.csv', sep = ',')
    data_igg = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\IgG_severo.csv', sep = ',')
    ...
    data_tcd4 = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\TCD4_severo (1).csv', sep = ',')
    data_tcd8 = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\TCD8_severo.csv', sep = ',')
    data_cellB = pd.read_csv(r'C:\Users\mique\OneDrive\Documentos\UFJF\Modelagem Fisiologica\Codigos\meus_dados\Dados_Corrigidos\Bcell_severo.csv', sep = ',')
